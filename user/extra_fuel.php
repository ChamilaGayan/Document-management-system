  ...
  <div id="content" class="p-4 p-md-5">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
       ...
       <h5>Extra Fuel</h5> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<!--Upload images-->
    <form action="php/efupload.php" method="post" enctype="multipart/form-data">
...
<option value="">None</option>
  ...
  <input type="file" name="file2" style="color:black;" class="dash"><br>
    ...
    <input type="file" style="color:black;" class="dash" name="file">
